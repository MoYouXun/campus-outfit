...
public interface OutfitService extends IService<Outfit> {
    IPage<com.campus.outfit.vo.OutfitVO> getPublicOutfits(int page, int size, String sortBy, Long topicId, Long targetUserId, Long currentUserId);
    Result<AiAnalysisResult> uploadAndAnalyze(List<MultipartFile> files);
    Result<String> publishOutfit(Outfit outfit);
    IPage<com.campus.outfit.vo.OutfitVO> getPublicOutfits(int page, int size);
    IPage<com.campus.outfit.vo.OutfitVO> getFollowingOutfits(java.util.List<Long> followingIds, int page, int size, Long currentUserId);
    IPage<com.campus.outfit.vo.OutfitVO> getMyOutfits(Long userId, int page, int size);
